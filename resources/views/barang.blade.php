                    ...
                    <div class="card-header d-flex justify-content-between">
                        <div>
                            ...
                            <div class="dropdown" style="display: inline-block;">
                                ...
                                <a href="{{ route('export.barcode') }}" class="btn btn-success" id="dropdownMenuButton">
                                    <i class="fas fa-qrcode"></i> Unduh Barcode
                                </a>
                            </div>
                        </div>
                        <div>
                            <button type="button" class="btn btn-success block" data-bs-toggle="modal" data-bs-target="#importModal">
                                <i class="fas fa-file-csv"></i> Import Excel
                            </button>
        ...
        <div class="modal-content">
            <form action="{{ route('barang.import') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="importModalLabel">Import File Barang</h5>
